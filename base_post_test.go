...
func TestBasicPostRequestInvalidURLNoParams(t *testing.T) {
	resp, _ := Post("%../dir/", &RqOptions{Data: map[string]string{"One": "Two"}})
...
func TestXMLPostRequestInvalidURL(t *testing.T) {
	resp, _ := Post("%../dir/",
		&RqOptions{XML: XMLPostMessage{Name: "Human", Age: 1, Height: 1}})
...
func TestBasicPostJsonRequestInvalidURL(t *testing.T) {
	_, err := Post("%../dir/",
		&RqOptions{JSON: map[string]string{"One": "Two"}, IsAjax: true})
...
func TestBasicPostJsonRequestInvalidJSON(t *testing.T) {
	resp, err := Post("http://httpbin.org/post",
		&RqOptions{JSON: math.NaN(), IsAjax: true})
...
func TestBasicPostJsonRequestInvalidXML(t *testing.T) {
	resp, err := Post("http://httpbin.org/post",
		&RqOptions{XML: map[string]string{"One": "two"}, IsAjax: true})
...
func TestXMLPostRequestReaderBody(t *testing.T) {
	...
	resp, _ := Post("http://httpbin.org/post",
		&RqOptions{RequestBody: bytes.NewReader(derBytes)})
...
func TestXMLNilPostRequest(t *testing.T) {
	resp, _ := Post("http://httpbin.org/post", &RqOptions{XML: nil})
...
func TestBasicPostJsonBytesRequest(t *testing.T) {
	resp, _ := Post("http://httpbin.org/post",
		&RqOptions{JSON: []byte(`{"One":"Two"}`), IsAjax: true})
...
func TestBasicPostJsonStringRequest(t *testing.T) {
	resp, _ := Post("http://httpbin.org/post",
		&RqOptions{JSON: `{"One":"Two"}`, IsAjax: true})
...
func TestPostSession(t *testing.T) {
	...
	resp, err = session.Post("http://httpbin.org/post", &RqOptions{Data: map[string]string{"one": "two"}})
